var RadioButtonEventListStorageComponent = {
    ...
    computed: {
        CheckedValue: {
            ...
            set(value) {
                console.log('set', value, value.target.value, this.name, this.checked_value);
//                window.localStorage.setItem(this.name, this.checked_value);
//                window.localStorage.setItem(this.name, value);
                window.sessionStorage.setItem(this.name, value.target.value);
//                checked_value = value.target.value;
            }
        }
    }
}
